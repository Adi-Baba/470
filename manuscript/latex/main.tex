...
\textbf{Proof.} We proceed by induction on the prime factors. For the base case $m_3 = 3 \cdot 5 \cdot 7 = 105$, the proper divisors are $\{1, 3, 5, 7, 15, 21, 35\}$, summing to 87. Direct evaluation shows the subset sums form a contiguous block $[15, 87]$, with fringe gaps at 2 and 14. Thus, $K = 15$ and $C_3 = 87$.
