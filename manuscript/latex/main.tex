...
\textbf{Proof.} The divisors of any integer generate a symmetric subset-sum distribution. For small initial cores, such as the base case $m_3 = 3 \cdot 5 \cdot 7 = 105$, direct evaluation shows the subset sums form a contiguous block $[3, 84]$, with a maximum fringe gap of $K = 3$. 
