...
\subsection{Definition 5.1 (The Deficient Core Target Constraint)}
\textit{The Deficient Core Target Constraint occurs when the deficiency of $M$ strictly requires the unscaled subset-sum target $T_A$ to exceed $\sigma(M)$.}
...
\subsection{Theorem 5.1 (The Deficient Core Target Constraint)}
