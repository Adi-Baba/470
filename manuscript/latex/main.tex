...
Achieving an abundancy index near 2 for an odd integer requires a product of the first $m$ consecutive odd primes. By Mertens' Third Theorem \cite{mertens1874}, the maximum abundancy grows logarithmically with the largest prime factor, $I \sim e^\gamma \ln(p_m)$. Therefore, the required core value $M'$, and consequently $S(p_k) = \sigma(M')$, must grow on the order of the primorial $p_m\# \sim e^{p_m}$. 
